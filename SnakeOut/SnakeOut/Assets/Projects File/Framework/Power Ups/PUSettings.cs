...
namespace Watermelon
{
    public abstract class PUSettings : ScriptableObject
    {
		...
		[Group("Purchase")]
		[SerializeField] int videoPurchaseAmountUsable;
		public int CoinPurchaseAmount => videoPurchaseAmountUsable;

		[Group("Purchase")]
		[SerializeField] int videoPurchaseAmount;
		public int VideoPurchaseAmount => videoPurchaseAmount;
        ...
        public void InitialiseSave()
        {
            ...
            if(save.PurchaseUseableVideo == -1)
            {
				save.PurchaseUseableVideo = videoPurchaseAmountUsable;
			}
		}
