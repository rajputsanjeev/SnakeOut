Shader "Toony Colors Pro 2/Legacy/Mobile_VF" {
	Properties {
		...
		[Toggle(_Use_WorldPosComputerBuffer)] _Use_WorldPosComputerBuffer ("世界坐标ComputerBuffer", Float) = 1
		...
		[Toggle(_UseBurn_ByUV2_GridLayout)] _UseBurn_ByUV2_GridLayout ("uv2网格化消融", Float) = 0
