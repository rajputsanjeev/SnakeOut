...
namespace Framework.Core
{
    public class EditorAdMobContainer : EditorAdsContainer
    {
        ...
        private void DrawAddUnitsSection()
        {
            ...
            DrawIdProperty(androidBannerIdProperty, Framework.Core.AdMobContainer.ANDROID_BANNER_TEST_ID);
            DrawIdProperty(iOSBannerIdProperty, Framework.Core.AdMobContainer.IOS_BANNER_TEST_ID);
            ...
            DrawIdProperty(androidInterstitialIdProperty, Framework.Core.AdMobContainer.ANDROID_INTERSTITIAL_TEST_ID);
            DrawIdProperty(iOSInterstitialIdProperty, Framework.Core.AdMobContainer.IOS_INTERSTITIAL_TEST_ID);

            EditorGUILayout.LabelField("Rewarded Video ID", groupStyle);
            DrawIdProperty(androidRewardedVideoIdProperty, Framework.Core.AdMobContainer.ANDROID_REWARDED_VIDEO_TEST_ID);
            DrawIdProperty(iOSRewardedVideoIdProperty, Framework.Core.AdMobContainer.IOS_REWARDED_VIDEO_TEST_ID);
            ...
            {
                DrawIdProperty(androidAppOpenAdIDProperty, Framework.Core.AdMobContainer.ANDROID_OPEN_TEST_ID);
                DrawIdProperty(iosAppOpenAdIDProperty, Framework.Core.AdMobContainer.IOS_OPEN_TEST_ID);
            }
            ...
            {
                androidBannerIdProperty.stringValue = Framework.Core.AdMobContainer.ANDROID_BANNER_TEST_ID;
                iOSBannerIdProperty.stringValue = Framework.Core.AdMobContainer.IOS_BANNER_TEST_ID;

                androidInterstitialIdProperty.stringValue = Framework.Core.AdMobContainer.ANDROID_INTERSTITIAL_TEST_ID;
                iOSInterstitialIdProperty.stringValue = Framework.Core.AdMobContainer.IOS_INTERSTITIAL_TEST_ID;

                androidRewardedVideoIdProperty.stringValue = Framework.Core.AdMobContainer.ANDROID_REWARDED_VIDEO_TEST_ID;
                iOSRewardedVideoIdProperty.stringValue = Framework.Core.AdMobContainer.IOS_REWARDED_VIDEO_TEST_ID;

                androidAppOpenAdIDProperty.stringValue = Framework.Core.AdMobContainer.ANDROID_OPEN_TEST_ID;
                iosAppOpenAdIDProperty.stringValue = Framework.Core.AdMobContainer.IOS_OPEN_TEST_ID;
            }
        }
