...
namespace Framework.Core
{
	...
	public class AdMobHandler : AdProviderHandler
	{
		...
		{
			var androidID = Initializer.IS_TESTING_ADS ? AdMobContainer.ANDROID_BANNER_TEST_ID : adsSettings.AdMobContainer.AndroidBannerID;
			var iosID = Initializer.IS_TESTING_ADS ? AdMobContainer.IOS_BANNER_TEST_ID : adsSettings.AdMobContainer.IOSBannerID;
		...
		{
			var androidID = Initializer.IS_TESTING_ADS ? AdMobContainer.ANDROID_INTERSTITIAL_TEST_ID : adsSettings.AdMobContainer.AndroidInterstitialID;
			var iosID = Initializer.IS_TESTING_ADS ? AdMobContainer.IOS_INTERSTITIAL_TEST_ID : adsSettings.AdMobContainer.IOSInterstitialID;
		...
		{
			var androidID = Initializer.IS_TESTING_ADS ? AdMobContainer.ANDROID_REWARDED_VIDEO_TEST_ID : adsSettings.AdMobContainer.AndroidRewardedVideoID;
			var iosID = Initializer.IS_TESTING_ADS ? AdMobContainer.IOS_REWARDED_VIDEO_TEST_ID : adsSettings.AdMobContainer.IOSRewardedVideoID;
